...
class TagsBindingsServiceProvider extends ServiceProvider
{
    ...
    */
    public $bindings = [
        ...
        'InetStudio\Tags\Contracts\Observers\TagObserverContract' => 'InetStudio\Tags\Observers\TagObserver',
        ...
        'InetStudio\Tags\Contracts\Services\Back\TagsObserverServiceContract' => 'InetStudio\Tags\Services\Back\TagsObserverService',
